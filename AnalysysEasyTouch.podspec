Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/AnalysysSDK/AnalysysEasyTouch_iOS_StaticLib"
  s.license      = { :type => "MIT", :file => "README.md" }
  s.author       = { "analysys" => "analysys@analysys.com.cn" }
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/AnalysysSDK/AnalysysEasyTouch_iOS_StaticLib.git", :tag => s.version }
  s.requires_arc = true
